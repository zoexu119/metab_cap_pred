...
if __name__ == '__main__':
    ...
    if not args.split_ready:
        _, _, _, _, test_smile, test_label = read_split_data(args.oversample, args.testfile, split_mode=args.split_mode, split_ratios=[args.split_train_ratio, args.split_valid_ratio], seed=args.split_seed)
    else:
        test_smile, test_label = read_split_data(args.oversample, args.testfile)
